	...
	<div id="main_page">
		...
		<form method="POST">
			<table id="main_table">
				...
				<tr>
					<td>제목</td>
					<td><input type="text" name="title" class="formInputData"/></td>
				</tr>
				<tr>
					<td>카테고리</td>
					<td><input type="text" name="category" class="formInputData"/></td>
				</tr>
				<tr>
					<td>국가</td>
					<td><select id="select_nation" name="nation" class="formInputData">
				...
				<tr>
					<td>가격</td>
					<td><input class="formInputData" type="text" name="price" /></td>
				</tr>
			</table>
			<input id="submitBtn" class="move_btn" type="submit" value="저장" />
		</form>
	</div>
